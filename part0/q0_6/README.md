...
```mermaid
	...
	Note right of browser : The JS code prevents the default action when we press save, adds the new note to the list, re-renders the page and sends this note, in json format, to the server.	
